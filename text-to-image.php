...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col text-center">
                <p>Note: To save an image to share on social media, right click on it, click "Save Image As...", and save it to your pc or mobile device. Our text-to-image generator is based on the open-source <a href="https://stability.ai/blog/stable-diffusion-public-release" target="new">Stable Diffusion</a> code from OpenAI. By using our version of their program, you must agree to their license terms at <a href="https://huggingface.co/spaces/CompVis/stable-diffusion-license" target="new">Stable Diffusion</a>. Both non-commercial and commercial usage is allowed but you can't use it to deliberately produce nor share illegal or harmful outputs or content. We claim no rights on the output you generate. You are free to use the images and are accountable for their use which must not go against the provisions set in the license.</p>
